...
const checklistItems: ChecklistItem[] = [
  {
    ...
    yesInfo: {
      ...
      content: 'Having a safe ride home is crucial. Whether it\'s a designated driver, rideshare app, or SafeRide, you\'ve taken an important step. Keep the contact info saved in your phone and confirm the plan with your group before drinking.',
      type: 'positive',
    },
    noInfo: {
      title: 'This is a critical safety issue',
      content: 'NEVER drink without a safe transportation plan. Download Uber/Lyft now, save the UC Davis SafeRide number (+1-530-752-3222), or arrange a designated driver. Impaired driving and walking home alone are the two most dangerous outcomes of a night out.',
      type: 'danger',
    },
  },
  {
    ...
    yesInfo: {
      ...
      content: 'Having a plan helps you stay in control. Share your itinerary with a trusted friend or roommate who\'s not going out. Include locations, expected timeline, and when you plan to be home.',
      type: 'info',
    },
    noInfo: {
      title: 'Consider making a loose plan',
      content: 'Spontaneity is fun, but having zero plan increases risk. At minimum, decide: (1) Where you\'re starting, (2) Rough timeline for the night, (3) When you need to be home. Text this info to a roommate.',
      type: 'warning',
    },
  },
  {
    ...
    yesInfo: {
      ...
      content: 'Going out with people you trust is one of the most important protective factors. Make a buddy system pact: check on each other throughout the night, intervene if someone is too intoxicated, and ensure everyone gets home safely.',
      type: 'positive',
    },
    noInfo: {
      title: 'High risk situation',
      content: 'Going out with people you don\'t trust well is extremely dangerous when drinking. Strongly reconsider this plan. If you must go, tell a trusted friend exactly where you\'ll be and check in hourly.',
      type: 'danger',
    },
  },
  {
    ...
    yesInfo: {
      ...
      content: 'Eating before drinking — especially carbohydrate-rich foods — slows alcohol absorption and reduces peak BAC. Keep hydrating throughout the night: alternate each alcoholic drink with a glass of water.',
      type: 'positive',
    },
    noInfo: {
      title: 'Stop and eat NOW',
      content: 'Drinking on an empty stomach dramatically increases blackout risk. Eat a substantial meal with carbs and protein before your first drink. Toast, pasta, rice, or a burger work great.',
      type: 'danger',
    },
  },
];
...
export function ChecklistPage({ onComplete }: ChecklistPageProps) {
                  ...
                  >
                    <h4
                      className={`font-semibold mb-2 md:text-lg ${
                        info.type === 'positive' ? 'text-green-900'
                        : info.type === 'info' ? 'text-blue-900'
                        : info.type === 'warning' ? 'text-yellow-900'
                        : 'text-red-900'
                      }`}
                    >
                      {info.title}
                    ...
                    <p
                      className={`text-sm md:text-base leading-relaxed ${
                        info.type === 'positive' ? 'text-green-800'
                        : info.type === 'info' ? 'text-blue-800'
                        : info.type === 'warning' ? 'text-yellow-800'
                        : 'text-red-800'
                      }`}
                    >
                      {info.content}
