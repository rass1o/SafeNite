...
interface ChecklistItem {
  ...
  yesInfo: { title: string; content: string; type: 'positive' | 'info'; };
  noInfo: { title: string; content: string; type: 'warning' | 'danger'; };
}
...
const checklistItems: ChecklistItem[] = [
  {
    ...
    icon: Car,
    yesInfo: { title: 'Great planning!', content: 'Having a safe ride home is crucial. Whether it\'s a designated driver, rideshare app, or SafeRide, you\'ve taken an important step. Keep the contact info saved in your phone and confirm the plan with your group before drinking.', type: 'positive' },
    noInfo: { title: 'This is a critical safety issue', content: 'NEVER drink without a safe transportation plan. Download Uber/Lyft now, save the UC Davis SafeRide number (+1-530-752-3222), or arrange a designated driver. Impaired driving and walking home alone are the two most dangerous outcomes of a night out.', type: 'danger' },
  },
  {
    id: 'itinerary',
    question: 'Do you have an itinerary for your night?',
    icon: Map,
    yesInfo: { title: 'Smart approach', content: 'Having a plan helps you stay in control. Share your itinerary with a trusted friend or roommate who\'s not going out. Include locations, expected timeline, and when you plan to be home. This creates accountability and helps if someone needs to check on you.', type: 'info' },
    noInfo: { title: 'Consider making a loose plan', content: 'Spontaneity is fun, but having zero plan increases risk. At minimum, decide: (1) Where you\'re starting, (2) Rough timeline for the night, (3) When you need to be home. Text this info to a roommate. Wandering between random locations while intoxicated puts you in vulnerable situations.', type: 'warning' },
  },
  {
    id: 'trusted_people',
    question: 'Are the people you\'re going with trusted?',
    icon: Users,
    yesInfo: { title: 'Your safety network', content: 'Going out with people you trust is one of the most important protective factors. Make a buddy system pact: check on each other throughout the night, intervene if someone is too intoxicated, and ensure everyone gets home safely. Real friends don\'t let friends black out alone.', type: 'positive' },
    noInfo: { title: 'High risk situation', content: 'Going out with people you don\'t trust well is extremely dangerous when drinking. Blackouts leave you vulnerable to harm, and strangers or acquaintances may not look out for you. Strongly reconsider this plan. If you must go, tell a trusted friend exactly where you\'ll be and check in hourly.', type: 'danger' },
  },
  {
    id: 'food',
    question: 'Did you eat before drinking?',
    icon: Utensils,
    yesInfo: { title: 'Excellent harm reduction', content: 'Eating before drinking—especially carbohydrate-rich foods—slows alcohol absorption and reduces peak BAC. This lowers blackout risk and hangover severity. Keep hydrating throughout the night: alternate each alcoholic drink with a glass of water. Your body will thank you tomorrow.', type: 'positive' },
    noInfo: { title: 'Stop and eat NOW', content: 'Drinking on an empty stomach dramatically increases blackout risk. Alcohol absorbs faster, leading to rapid BAC spikes. Eat a substantial meal with carbs and protein before your first drink. Toast, pasta, rice, or a burger work great. Also, drink a full glass of water right now and continue hydrating.', type: 'danger' },
  },
];
...
export function ChecklistPage({ onAnswersChange }: ChecklistPageProps) {
